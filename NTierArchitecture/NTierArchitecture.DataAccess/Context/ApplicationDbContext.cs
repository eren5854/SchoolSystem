...
public sealed class ApplicationDbContext : IdentityDbContext<AppUser, IdentityRole<Guid>, Guid>
{
    ...
    {
        modelBuilder.Entity<Student>().HasQueryFilter(filter => !filter.IsDeleted);//yazacağımız tüm sorgularda yandaki filtreleme işlemini ekliyor. birden fazla sorguda aynı işlemi yapacaksan bunu kullan.
